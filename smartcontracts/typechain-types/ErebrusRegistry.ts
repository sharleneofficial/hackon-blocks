...
export interface ErebrusRegistryInterface extends utils.Interface {
  ...
  functions: {
    ...
    "delegateRegisterVpnNode((address,address,string,string,string,string,string,uint8))": FunctionFragment;
    "delegateRegisterWifiNode(address,string,address,string,string,uint256)": FunctionFragment;
    "didToUser(address)": FunctionFragment;
    "getWifiDetails(uint256)": FunctionFragment;
    "readAttribute(address,bytes)": FunctionFragment;
    "registerVpnNode((address,address,string,string,string,string,string,uint8))": FunctionFragment;
    "registerWifiNode(string,address,string,string,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "delegateRegisterVpnNode",
    values: [ErebrusRegistry.VPNNodeStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "delegateRegisterWifiNode",
...
export interface ErebrusRegistry extends BaseContract {
  ...
  functions: {
    ...
    delegateRegisterVpnNode(
      node: ErebrusRegistry.VPNNodeStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    delegateRegisterWifiNode(
      user: string,
      _deviceId: string,
      _peaqDid: string,
      _ssid: string,
