...
export interface IEREBRUSMASTERInterface extends utils.Interface {
  contractName: "IEREBRUSMASTER";
  functions: {
...
export interface IEREBRUSMASTER extends BaseContract {
  contractName: "IEREBRUSMASTER";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEREBRUSMASTERInterface;
